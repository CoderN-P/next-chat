...
export const LoginButton = () => {
  return (
    <button className="dark:bg-neutral-900 m-2 border dark:border-neutral-800 space-x-2 rounded-md flex flex-row" onClick={() => signIn('google')}>
        <p className="text-3xl hover:bg-neutral-800 m-4 mr-2 "><code className="text-3xl bg-transparent">Sign in</code></p>
        <div className="p-4 border-l h-full dark:bg-neutral-950 dark:border-neutral-700">
