...
export default function ChatHeader({chat, toggleSidebar, toggleMemberSidebar, owner} : {chat: Chat | null, toggleSidebar: Function, toggleMemberSidebar: Function, owner: null | boolean}){
    return (
