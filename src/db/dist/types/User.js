...
var User = /** @class */ (function () {
    function User(_id, name, email, image, createdAt, friends, chats, status, customStatus, lastReadChat, googleId, phoneNumber) {
        if (_id === void 0) { _id = (0, snowflake_1.generateSnowflake)(); }
    ...
    User.convertFromJSON = function (json) {
        return new User(json._id ? json._id : (0, snowflake_1.generateSnowflake)(), json.name, json.email, json.image, json.createdAt ? json.createdAt : new Date(), json.friends ? json.friends : [], json.chats ? json.chats : [], json.status ? json.status : "", json.customStatus ? json.customStatus : "", json.lastReadChat ? json.lastReadChat : "", json.googleId, json.phoneNumber ? json.phoneNumber : "");
    };
    return User;
}());
exports.User = User;
