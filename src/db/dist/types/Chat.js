...
var Chat = /** @class */ (function () {
    ...
    Chat.convertFromJSON = function (json) {
        return new Chat(json._id ? json._id : (0, snowflake_1.generateSnowflake)(), json.name, json.users, json.messages ? json.messages : [], json.createdAt ? json.createdAt : new Date(), json.avatar ? json.avatar : "", json.owner);
    };
    return Chat;
}());
exports.Chat = Chat;
