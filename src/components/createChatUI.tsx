  ...
  return (
    <div className={className}>
      <div className="flex flex-row mb-2 justify-between items-center">
        ...
        <input onInput={(e) => setInputText(e.target.value)} type="text" className=" flex-1 w-4/5 rounded-md border-l dark:border-neutral-800 p-2 dark:bg-neutral-950 dark:hover:bg-neutral-900" placeholder="Enter a name"/>
