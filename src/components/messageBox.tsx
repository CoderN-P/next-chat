...
export default function MessageBox({sendMessage} : {sendMessage: Function}){
    ...
    return (
        <div className="flex flex-row rounded-md bg-neutral-100 relative top-0 h-16 left-0 dark:bg-neutral-900 dark:hover:bg-neutral-800 m-4">
            <input onInput={e => setInput(e.target.value)} className="rounded-l-md flex-1 bg-transparent shadow p-2 px-6 h-16 items-center" type="text" placeholder="Message @NP"/>
