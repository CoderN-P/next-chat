...
export const LoginButton = () => {
  return (
    <button className="dark:bg-neutral-900 m-2 hover:bg-neutral-800 p-4 space-x-2 rounded-md flex flex-row" onClick={() => signIn('google')}>
        <p className="text-2xl mr-2 font-bold">Sign in with Google</p>
